...
Opal.modules["bullet"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$attr_reader', '$each', '$new', '$[]', '$[]=', '$all?', '$dead?', '$map', '$to_proc', '$identity', '$Native', '$makeRotationFromEuler', '$born?', '$!', '$multiply', '$matrix', '$each_with_object', '$<<', '$matrixes', '$__send__', '$same_fire_delay', '$life', '$age', '$delay', '$min', '$makeTranslation', '$clone', '$local_matrix', '$sqrt', '$lambda', '$-@']);
  self.$require("opal");
  self.$require("native");
  self.$require("math");
  self.$include($scope.get('Math'));
  (function($base, $super) {
    function $Bullet(){};
    ...
    def.modules = nil;
    self.$attr_reader("modules");

    def.$initialize = function(module_list) {
      var $a, $b, TMP_1, self = this;

      self.modules = $hash2([], {});
      return ($a = ($b = module_list).$each, $a.$$p = (TMP_1 = function(key, value){var self = TMP_1.$$s || this, bm = nil;
        if (self.modules == null) self.modules = nil;
if (key == null) key = nil;if (value == null) value = nil;
      bm = $scope.get('BulletModule').$new(value['$[]']("index"), value['$[]']("rot"), self.modules['$[]'](value['$[]']("parent")), value['$[]']("timing"));
        return self.modules['$[]='](key, bm);}, TMP_1.$$s = self, TMP_1), $a).call($b);
    };

    def['$dead?'] = function(frame) {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = self.modules)['$all?'], $a.$$p = (TMP_2 = function(k, v){var self = TMP_2.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
      return v['$dead?'](frame)}, TMP_2.$$s = self, TMP_2), $a).call($b);
    };

    def.$matrixes = function(frame, init_rot_vector) {
      var $a, $b, TMP_3, self = this, ret = nil;

      if (init_rot_vector == null) {
        init_rot_vector = [0, 0, 0]
      }
      ret = $hash2([], {});
      ($a = ($b = self.modules).$map, $a.$$p = (TMP_3 = function(key, bm){var self = TMP_3.$$s || this, $a, $b, $c, TMP_4, $d, $e, gamma = nil, beta = nil, alpha = nil, mi = nil, euler = nil, available = nil;
if (key == null) key = nil;if (bm == null) bm = nil;
      $a = Opal.to_ary(($b = ($c = ($d = ($e = init_rot_vector).$map, $d.$$p = "to_f".$to_proc(), $d).call($e)).$map, $b.$$p = (TMP_4 = function(t){var self = TMP_4.$$s || this;
if (t == null) t = nil;
        return $rb_divide($rb_times(t, $scope.get('PI')), 180)}, TMP_4.$$s = self, TMP_4), $b).call($c)), gamma = ($a[0] == null ? nil : $a[0]), beta = ($a[1] == null ? nil : $a[1]), alpha = ($a[2] == null ? nil : $a[2]);
        mi = self.$Native(new THREE.Matrix4()).$identity();
        euler = self.$Native(new THREE.Euler(alpha, beta, gamma, "ZYX"));
        mi.$makeRotationFromEuler(euler);
        available = ($a = bm['$born?'](frame), $a !== false && $a !== nil ?bm['$dead?'](frame)['$!']() : $a);
        return ret['$[]='](key, [mi.$multiply(bm.$matrix(frame)), available]);}, TMP_3.$$s = self, TMP_3), $a).call($b);
      return ret;
    };

    return (def.$fire = function(rot_vector) {
      var $a, $b, TMP_5, $d, $e, TMP_6, self = this, ret = nil, frame = nil;

      if (rot_vector == null) {
        rot_vector = [0, 0, 0]
      }
      ret = ($a = ($b = self.modules).$each_with_object, $a.$$p = (TMP_5 = function($c, s){var self = TMP_5.$$s || this;
var k = $c[0];var v = $c[1];if (s == null) s = nil;
      return s['$[]='](k, [])}, TMP_5.$$s = self, TMP_5), $a).call($b, $hash2([], {}));
      frame = 0;
      while (!((($d = self['$dead?'](frame)) !== nil && (!$d.$$is_boolean || $d == true)))) {
      ($d = ($e = self.$matrixes(frame, rot_vector)).$each, $d.$$p = (TMP_6 = function(k, v){var self = TMP_6.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
      return ret['$[]'](k)['$<<'](v)}, TMP_6.$$s = self, TMP_6), $d).call($e);
      frame = $rb_plus(frame, 1);};
      return ret;
    }, nil) && 'fire';
  })(self, null);
  (function($base, $super) {
    function $BulletModule(){};
    var self = $BulletModule = $klass($base, $super, 'BulletModule', $BulletModule);

    var def = self.$$proto, $scope = self.$$scope;

    def.parent = def.timing = def.life = def.formula_position = def.formula_direction = def.initial_matrix = def.following = nil;
    self.$attr_reader("same_fire_delay", "life");

    def.$initialize = function(index, init_rot_vector, parent, timing) {
      var $a, $b, $c, TMP_7, $d, $e, self = this, gamma = nil, beta = nil, alpha = nil, euler = nil, mr = nil, mi = nil, name = nil, following = nil, type = nil, param = nil;
      ...
      $a = Opal.to_ary(($b = ($c = ($d = ($e = init_rot_vector).$map, $d.$$p = "to_f".$to_proc(), $d).call($e)).$map, $b.$$p = (TMP_7 = function(t){var self = TMP_7.$$s || this;
if (t == null) t = nil;
      return $rb_divide($rb_times(t, $scope.get('PI')), 180)}, TMP_7.$$s = self, TMP_7), $b).call($c)), gamma = ($a[0] == null ? nil : $a[0]), beta = ($a[1] == null ? nil : $a[1]), alpha = ($a[2] == null ? nil : $a[2]);
      euler = self.$Native(new THREE.Euler(alpha, beta, gamma, "ZYX"));
      mr = self.$Native(new THREE.Matrix4()).$makeRotationFromEuler(euler);
      mi = self.$Native(new THREE.Matrix4()).$multiply(mr);
      self.initial_matrix = mi;
      self.parent = parent;
      self.timing = timing;
      self.log = [];
      ...
      return ($a = self).$__send__.apply($a, [type].concat(param));
    };
    ...
    def.$delay = function() {
      ...
      if ((($a = self.parent) !== nil && (!$a.$$is_boolean || $a == true))) {
        return $hash2(["s", "v", "d02", "d05", "d10", "d20", "d30", "d50", "d100"], {"s": self.parent.$same_fire_delay(), "v": self.parent.$life(), "d02": 6, "d05": 15, "d10": 30, "d20": 60, "d30": 90, "d50": 150, "d100": 300})['$[]'](self.timing)
        } else {
        return 0
      };
    };

    def.$age = function(frame) {
      var $a, self = this;

      if ((($a = self.parent) !== nil && (!$a.$$is_boolean || $a == true))) {
        return $rb_minus(self.parent.$age(frame), self.$delay())
        } else {
        return frame
      };
    };

    def['$born?'] = function(frame) {
      var self = this;

      return $rb_ge(self.$age(frame), 0);
    };

    def['$dead?'] = function(frame) {
      var self = this;

      return $rb_gt(self.$age(frame), self.life);
    };

    def.$local_matrix = function(age) {
      var $a, self = this, frame = nil, x = nil, y = nil, z = nil, gamma = nil, beta = nil, alpha = nil, euler = nil, mr = nil, mt = nil;
    ...
    def.$matrix = function(frame) {
      var $a, self = this, parent_age = nil, m_p = nil, m_l = nil;
      ...
      if ((($a = self.parent) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        return self.$local_matrix(frame)
      };
    };

    def.$straight = function(size, length) {
      var $a, $b, TMP_8, $c, TMP_9, self = this, speed = nil;
...
if (x == null) x = nil;
    ...
    def.$drilling = function(size, length) {
      var $a, $b, TMP_10, $c, TMP_11, self = this, speed = nil, rot_speed = nil;
...
if (x == null) x = nil;
      return [0, 0, $rb_times(x, rot_speed)]}, TMP_11.$$s = self, TMP_11), $a).call($c);
      return self;
    };

    def.$circle = function(size, dia) {
      var $a, $b, TMP_12, $c, TMP_13, self = this, rot_speed = nil;
      ...
      self.formula_position = ($a = ($b = self).$lambda, $a.$$p = (TMP_12 = function(x){var self = TMP_12.$$s || this;
if (x == null) x = nil;
      return [dia, 0, 0]}, TMP_12.$$s = self, TMP_12), $a).call($b);
      self.formula_direction = ($a = ($c = self).$lambda, $a.$$p = (TMP_13 = function(x){var self = TMP_13.$$s || this;
if (x == null) x = nil;
      return [$rb_times(x, rot_speed), 0, 0]}, TMP_13.$$s = self, TMP_13), $a).call($c);
    ...
    def.$ball = function(life) {
      ...
      self.formula_position = ($a = ($b = self).$lambda, $a.$$p = (TMP_14 = function(x){var self = TMP_14.$$s || this;
if (x == null) x = nil;
      return [0, 0, 0]}, TMP_14.$$s = self, TMP_14), $a).call($b);
      self.formula_direction = ($a = ($c = self).$lambda, $a.$$p = (TMP_15 = function(x){var self = TMP_15.$$s || this;
if (x == null) x = nil;
      return [0, 0, 0]}, TMP_15.$$s = self, TMP_15), $a).call($c);
      return self;
    };

    return (def.$spinball = function(speed) {
      var $a, $b, TMP_16, $c, TMP_17, self = this, rot_speed = nil;
      ...
      self.formula_position = ($a = ($b = self).$lambda, $a.$$p = (TMP_16 = function(x){var self = TMP_16.$$s || this;
if (x == null) x = nil;
      return [0, 0, 0]}, TMP_16.$$s = self, TMP_16), $a).call($b);
      self.formula_direction = ($a = ($c = self).$lambda, $a.$$p = (TMP_17 = function(x){var self = TMP_17.$$s || this;
if (x == null) x = nil;
      return [$rb_times(x, rot_speed), 0, 0]}, TMP_17.$$s = self, TMP_17), $a).call($c);
      return self;
    }, nil) && 'spinball';
  })(self, null);
  return (function($base, $super) {
    ...
    return Opal.cdecl($scope, 'MODULE_LIST', [["[SS]弾丸:直進/長", false, "straight", "ss", "l"], ["[SS]弾丸:直進/短", false, "straight", "ss", "s"], ["[SS]弾丸:直進/極短", false, "straight", "ss", "ss"], ["[SS]きりもみ弾/長", false, "drilling", "ss", "l"], ["[SS]きりもみ弾/短", false, "drilling", "ss", "s"], ["[SS]きりもみ弾/極短", false, "drilling", "ss", "ss"], ["[SS]弾丸:回転/通常", false, "circle", "ss", "m"], ["[SS]弾丸:回転/広", false, "circle", "ss", "l"], ["[SS]弾丸:回転/狭い", false, "circle", "ss", "s"], ["[SS]弾丸:追従回転/通常", true, "circle", "ss", "m"], ["[SS]弾丸:追従回転/広", true, "circle", "ss", "l"], ["[SS]弾丸:追従回転/狭い", true, "circle", "ss", "s"], ["[S]弾丸:直進/長", false, "straight", "s", "l"], ["[S]弾丸:直進/短", false, "straight", "s", "s"], ["[S]弾丸:直進/極短", false, "straight", "s", "ss"], ["[S]きりもみ弾/長", false, "drilling", "s", "l"], ["[S]きりもみ弾/短", false, "drilling", "s", "s"], ["[S]きりもみ弾/極短", false, "drilling", "s", "ss"], ["[S]弾丸:回転/通常", false, "circle", "s", "m"], ["[S]弾丸:回転/広", false, "circle", "s", "l"], ["[S]弾丸:回転/狭い", false, "circle", "s", "s"], ["[S]弾丸:追従回転/通常", true, "circle", "s", "m"], ["[S]弾丸:追従回転/広", true, "circle", "s", "l"], ["[S]弾丸:追従回転/狭い", true, "circle", "s", "s"], ["[M]弾丸:直進/長", false, "straight", "m", "l"], ["[M]弾丸:直進/短", false, "straight", "m", "s"], ["[M]弾丸:直進/極短", false, "straight", "m", "ss"], ["[M]きりもみ弾/長", false, "drilling", "m", "l"], ["[M]きりもみ弾/短", false, "drilling", "m", "s"], ["[M]きりもみ弾/極短", false, "drilling", "m", "ss"], ["[M]弾丸:回転/通常", false, "circle", "m", "m"], ["[M]弾丸:回転/広", false, "circle", "m", "l"], ["[M]弾丸:回転/狭い", false, "circle", "m", "s"], ["[M]弾丸:追従回転/通常", true, "circle", "m", "m"], ["[M]弾丸:追従回転/広", true, "circle", "m", "l"], ["[M]弾丸:追従回転/狭い", true, "circle", "m", "s"], ["[M]制御:静止/生存時間普通", false, "ball", "m"], ["[M]制御:静止/生存時間極長", false, "ball", "ll"], ["[M]制御:静止/生存時間長", false, "ball", "l"], ["[M]制御:静止/生存時間短", false, "ball", "s"], ["[M]制御:追従/生存時間普通", true, "ball", "m"], ["[M]制御:追従/生存時間短", true, "ball", "s"], ["[M]制御:回転/速度普通", false, "spinball", "mid"], ["[M]制御:回転/速度遅", false, "spinball", "slow"], ["[M]制御:回転/速度速", false, "spinball", "fast"], ["[L]弾丸:直進/長", false, "straight", "l", "l"], ["[L]弾丸:直進/短", false, "straight", "l", "s"], ["[L]弾丸:直進/極短", false, "straight", "l", "ss"], ["[L]きりもみ弾/長", false, "drilling", "l", "l"], ["[L]きりもみ弾/短", false, "drilling", "l", "s"], ["[L]きりもみ弾/極短", false, "drilling", "l", "ss"], ["[L]弾丸:回転/通常", false, "circle", "l", "m"], ["[L]弾丸:回転/広", false, "circle", "l", "l"], ["[L]弾丸:回転/狭い", false, "circle", "l", "s"], ["[L]弾丸:追従回転/通常", true, "circle", "l", "m"], ["[L]弾丸:追従回転/広", true, "circle", "l", "l"], ["[L]弾丸:追従回転/狭い", true, "circle", "l", "s"]])
  })(self, null);
};

/* Generated by Opal 0.8.1 */
Opal.modules["anime"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  }
  ...
  Opal.add_stubs(['$require', '$include', '$getElementById', '$document', '$max', '$innerWidth', '$clientWidth', '$innerHeight', '$Native', '$set', '$up', '$z=', '$position', '$x=', '$y=', '$add', '$to_n', '$castShadow=', '$shadowCameraLeft=', '$shadowCameraRight=', '$shadowCameraTop=', '$shadowCameraBottom=', '$shadowCameraNear=', '$near', '$shadowCameraFar=', '$far', '$shadowBias=', '$shadowDarkness=', '$shadowMapWidth=', '$shadowMapHeight=', '$side=', '$translate', '$receiveShadow=', '$opacity=', '$material', '$transparent=', '$rotation', '$each', '$push', '$vertices', '$setClearColor', '$setSize', '$enabled=', '$shadowMap', '$domElement', '$appendChild', '$addEventListener', '$redraw', '$value', '$requestAnimationFrame', '$update', '$tooltip_update', '$render', '$innerText=', '$to_i', '$map', '$to_proc', '$[]', '$index', '$rindex', '$setDrawRange', '$geometry', '$needsUpdate=', '$attributes', '$nil?', '$visible=', '$min', '$setFromMatrixPosition', '$x', '$-@', '$y', '$z', '$multiplyScalar', '$size', '$addAttribute', '$with_index', '$[]=', '$array', '$bullet_module_no=', '$<<', '$makeScale', '$multiply', '$rotateZ', '$rotateY', '$atan', '$sqrt', '$scale', '$applyMatrix', '$bullet_module_frame=', '$max=', '$value=', '$getBoundingClientRect', '$target', '$clientX', '$left', '$clientY', '$top', '$createElement', '$id=', '$innerHTML=', '$position=', '$style', '$display=', '$unproject', '$normalize', '$sub', '$compact', '$flatten', '$values', '$intersectObjects', '$length', '$!', '$==', '$object', '$setHex', '$color', '$currentHex', '$clone', '$currentHex=', '$getHex', '$bullet_module_no', '$bullet_module_frame', '$decompose', '$setFromQuaternion', '$round', '$left=', '$top=', '$getStyle', '$remove', '$dispose']);
  self.$require("opal");
  self.$require("native");
  self.$require("math");
  self.$require("bullet");
  self.$include($scope.get('Math'));
  $gvars.mouse = $hash2(["x", "y"], {"x": 0, "y": 0});
  $gvars.intersected = nil;
  $gvars.scale = 100;
  $gvars.winwidth = $rb_divide(640, 2);
  $gvars.winheight = $rb_divide(480, 2);
  $gvars.bullet_datas = $hash2([], {});
  $gvars.bullet_cubes = $hash2([], {});
  $gvars.bullet_lines = $hash2([], {});
  Opal.Object.$$proto.$init_anime = function() {
    var $a, $b, TMP_1, $c, TMP_2, self = this, el_mc = nil, el_ctl = nil, light = nil, plane_geometry = nil, plane_material = nil, plane_geometry_n = nil, plane_material_n = nil, plane = nil, grid_xz = nil, grid_xy = nil, lgeo = nil, verts = nil, lmat = nil, lgeo_n = nil, lmat_n = nil, centerline = nil, camera_native = nil, domelement_native = nil, frame_controler = nil;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.winwidth == null) $gvars.winwidth = nil;
    if ($gvars.winheight == null) $gvars.winheight = nil;
    if ($gvars.camera == null) $gvars.camera = nil;
    if ($gvars.scene == null) $gvars.scene = nil;
    if ($gvars.scale == null) $gvars.scale = nil;
    if ($gvars.renderer == null) $gvars.renderer = nil;

    el_mc = $gvars.win.$document().$getElementById("module_container");
    el_ctl = $gvars.win.$document().$getElementById("controlers");
    $gvars.winwidth = [$rb_minus($rb_minus($gvars.win.$innerWidth(), el_mc.$clientWidth()), 60), 320].$max();
    $gvars.winheight = [$rb_minus($gvars.win.$innerHeight(), 50), 240].$max();
    $gvars.scene = self.$Native(new THREE.Scene());
    $gvars.camera = self.$Native(new THREE.PerspectiveCamera( 75, $rb_divide($gvars.winwidth, $gvars.winheight), 1, 10000 ));
    $gvars.camera.$up().$set(0, 0, 1);
    (($a = [500]), $b = $gvars.camera.$position(), $b['$z='].apply($b, $a), $a[$a.length-1]);
    (($a = [-500]), $b = $gvars.camera.$position(), $b['$x='].apply($b, $a), $a[$a.length-1]);
    (($a = [-500]), $b = $gvars.camera.$position(), $b['$y='].apply($b, $a), $a[$a.length-1]);
    $gvars.scene.$add(self.$Native(new THREE.AmbientLight( 0xe0e0e0 )).$to_n());
    light = self.$Native(new THREE.DirectionalLight( 0xffffff, 1 ));
    light.$position().$set(0, 0, 1000);
    (($a = [true]), $b = light, $b['$castShadow='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(-5, $gvars.scale)]), $b = light, $b['$shadowCameraLeft='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(25, $gvars.scale)]), $b = light, $b['$shadowCameraRight='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(5, $gvars.scale)]), $b = light, $b['$shadowCameraTop='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(-5, $gvars.scale)]), $b = light, $b['$shadowCameraBottom='].apply($b, $a), $a[$a.length-1]);
    (($a = [$gvars.camera.$near()]), $b = light, $b['$shadowCameraNear='].apply($b, $a), $a[$a.length-1]);
    (($a = [$gvars.camera.$far()]), $b = light, $b['$shadowCameraFar='].apply($b, $a), $a[$a.length-1]);
    (($a = [0.8]), $b = light, $b['$shadowBias='].apply($b, $a), $a[$a.length-1]);
    (($a = [0.5]), $b = light, $b['$shadowDarkness='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(1028, 4)]), $b = light, $b['$shadowMapWidth='].apply($b, $a), $a[$a.length-1]);
    (($a = [$rb_times(1028, 4)]), $b = light, $b['$shadowMapHeight='].apply($b, $a), $a[$a.length-1]);
    $gvars.scene.$add(light);
    plane_geometry = self.$Native(new THREE.PlaneGeometry(6000, 2000));
    plane_material = self.$Native(new THREE.MeshBasicMaterial( { color: 0xf0f0f0 } ));
    (($a = [THREE.DoubleSide]), $b = plane_material, $b['$side='].apply($b, $a), $a[$a.length-1]);
    plane_geometry.$translate(2000, 0, 0);
    plane_geometry_n = plane_geometry.$to_n();
    plane_material_n = plane_material.$to_n();
    plane = self.$Native(new THREE.Mesh( plane_geometry_n, plane_material_n ));
    (($a = [-42.3]), $b = plane.$position(), $b['$z='].apply($b, $a), $a[$a.length-1]);
    ...
    (($a = [$rb_divide($scope.get('PI'), 2)]), $b = grid_xy.$rotation(), $b['$x='].apply($b, $a), $a[$a.length-1]);
    (($a = [-42.2]), $b = grid_xy.$position(), $b['$z='].apply($b, $a), $a[$a.length-1]);
    (($a = [0.15]), $b = grid_xy.$material(), $b['$opacity='].apply($b, $a), $a[$a.length-1]);
    (($a = [true]), $b = grid_xy.$material(), $b['$transparent='].apply($b, $a), $a[$a.length-1]);
    $gvars.scene.$add(grid_xy);
    lgeo = self.$Native(new THREE.Geometry());
    verts = [new THREE.Vector3(-50, 0, 0), new THREE.Vector3(50, 0, 0), new THREE.Vector3(0, -50, 0), new THREE.Vector3(0, 50, 0), new THREE.Vector3(0, 0, -50), new THREE.Vector3(0, 0, 50)];
    ($a = ($b = verts).$each, $a.$$p = (TMP_1 = function(seg){var self = TMP_1.$$s || this;
if (seg == null) seg = nil;
    return lgeo.$vertices().$push(seg)}, TMP_1.$$s = self, TMP_1), $a).call($b);
    lmat = self.$Native(new THREE.LineBasicMaterial({color: 0x000000}));
    $a = [lgeo.$to_n(), lmat.$to_n()], lgeo_n = $a[0], lmat_n = $a[1];
    centerline = self.$Native(new THREE.LineSegments(lgeo_n, lmat_n));
    (($a = [0.8]), $c = centerline, $c['$opacity='].apply($c, $a), $a[$a.length-1]);
    $gvars.scene.$add(centerline);
    $gvars.renderer = self.$Native(new THREE.WebGLRenderer());
    $gvars.renderer.$setClearColor(15790320);
    $gvars.renderer.$setSize($gvars.winwidth, $gvars.winheight);
    (($a = [true]), $c = $gvars.renderer.$shadowMap(), $c['$enabled='].apply($c, $a), $a[$a.length-1]);
    camera_native = $gvars.camera.$to_n();
    domelement_native = $gvars.renderer.$domElement().$to_n();
    $gvars.controls = self.$Native(new THREE.OrbitControls(camera_native, domelement_native));
    $gvars.win.$document().$getElementById("anime_container").$appendChild($gvars.renderer.$domElement().$to_n());
    frame_controler = $gvars.win.$document().$getElementById("frame_controler");
    return ($a = ($c = frame_controler).$addEventListener, $a.$$p = (TMP_2 = function(event){var self = TMP_2.$$s || this;
if (event == null) event = nil;
    return self.$redraw(frame_controler.$value())}, TMP_2.$$s = self, TMP_2), $a).call($c, "input");
  };
  Opal.Object.$$proto.$animate = function() {
    var self = this;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.controls == null) $gvars.controls = nil;
    if ($gvars.renderer == null) $gvars.renderer = nil;
    if ($gvars.scene == null) $gvars.scene = nil;
    if ($gvars.camera == null) $gvars.camera = nil;

    $gvars.win.$requestAnimationFrame(Opal.Kernel.$animate);
    $gvars.controls.$update();
    $scope.get('Kernel').$tooltip_update();
    return $gvars.renderer.$render($gvars.scene, $gvars.camera);
  };
  Opal.Object.$$proto.$redraw = function(frame) {
    var $a, $b, TMP_3, $c, TMP_4, self = this;
    if ($gvars.max_frame == null) $gvars.max_frame = nil;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.bullet_lines == null) $gvars.bullet_lines = nil;
    if ($gvars.bullet_cubes == null) $gvars.bullet_cubes = nil;

    (($a = ["" + (frame) + "/" + ($gvars.max_frame)]), $b = $gvars.win.$document().$getElementById("frameview"), $b['$innerText='].apply($b, $a), $a[$a.length-1]);
    frame = frame.$to_i();
    ($a = ($b = $gvars.bullet_lines).$each, $a.$$p = (TMP_3 = function(no, line){var self = TMP_3.$$s || this, $a, $b, $c, flags = nil, s = nil, e = nil;
      if ($gvars.bullet_datas == null) $gvars.bullet_datas = nil;
if (no == null) no = nil;if (line == null) line = nil;
    flags = ($a = ($b = $gvars.bullet_datas['$[]'](no)).$map, $a.$$p = "last".$to_proc(), $a).call($b);
      s = flags.$index(true);
      e = flags.$rindex(true);
      if ($rb_lt(frame, s)) {
        line.$geometry().$setDrawRange(s, 0)
      } else if ($rb_lt(e, frame)) {
        line.$geometry().$setDrawRange(s, $rb_plus($rb_minus(e, s), 1))
        } else {
        line.$geometry().$setDrawRange(s, $rb_plus($rb_minus(frame, s), 1))
      };
      return (($a = [true]), $c = line.$geometry().$attributes().$position(), $c['$needsUpdate='].apply($c, $a), $a[$a.length-1]);}, TMP_3.$$s = self, TMP_3), $a).call($b);
    return ($a = ($c = $gvars.bullet_cubes).$each, $a.$$p = (TMP_4 = function(no, cubes){var self = TMP_4.$$s || this, $a, $b, $c, TMP_5, $d, TMP_6, flags = nil, s = nil, e = nil;
      if ($gvars.bullet_datas == null) $gvars.bullet_datas = nil;
if (no == null) no = nil;if (cubes == null) cubes = nil;
    flags = ($a = ($b = $gvars.bullet_datas['$[]'](no)).$map, $a.$$p = "last".$to_proc(), $a).call($b);
      s = flags.$index(true);
      e = flags.$rindex(true);
      ($a = ($c = cubes).$each, $a.$$p = (TMP_5 = function(cube){var self = TMP_5.$$s || this, $a, $b;
if (cube == null) cube = nil;
      if ((($a = cube['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil;};
        return (($a = [false]), $b = cube.$material(), $b['$visible='].apply($b, $a), $a[$a.length-1]);}, TMP_5.$$s = self, TMP_5), $a).call($c);
      if ($rb_lt(s, frame)) {
        return ($a = ($d = cubes['$[]']($range(s, ([frame, e].$min()), false))).$each, $a.$$p = (TMP_6 = function(cube){var self = TMP_6.$$s || this, $a, $b;
if (cube == null) cube = nil;
        return (($a = [true]), $b = cube.$material(), $b['$visible='].apply($b, $a), $a[$a.length-1])}, TMP_6.$$s = self, TMP_6), $a).call($d)
        } else {
        return nil
      };}, TMP_4.$$s = self, TMP_4), $a).call($c);
  };
  Opal.Object.$$proto.$init_bullet = function() {
    var $a, $b, TMP_7, $c, TMP_10, $d, TMP_12, $e, $f, self = this, frame_controler = nil;
    if ($gvars.bullet_datas == null) $gvars.bullet_datas = nil;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.max_frame == null) $gvars.max_frame = nil;

    $gvars.bullet_lines = $hash2([], {});
    ($a = ($b = $gvars.bullet_datas).$each, $a.$$p = (TMP_7 = function(no, bullet_data){var self = TMP_7.$$s || this, $a, $b, TMP_8, $c, TMP_9, $d, vectors = nil, geometry = nil, maxpoints = nil, positions = nil, co = nil, material = nil, geometry_native = nil, material_native = nil, line = nil;
      if ($gvars.bullet_lines == null) $gvars.bullet_lines = nil;
      if ($gvars.scene == null) $gvars.scene = nil;
if (no == null) no = nil;if (bullet_data == null) bullet_data = nil;
    vectors = ($a = ($b = bullet_data).$map, $a.$$p = (TMP_8 = function(fd){var self = TMP_8.$$s || this, matrix = nil, available = nil, v = nil, v_r = nil;
        if ($gvars.scale == null) $gvars.scale = nil;
if (fd == null) fd = nil;
      matrix = fd['$[]'](0);
        available = fd['$[]'](1);
        v = self.$Native(new THREE.Vector3()).$setFromMatrixPosition(matrix);
        v_r = self.$Native(new THREE.Vector3()).$set(v.$x(), v.$y()['$-@'](), v.$z()['$-@']());
        return v_r.$multiplyScalar($gvars.scale);}, TMP_8.$$s = self, TMP_8), $a).call($b);
      geometry = self.$Native(new THREE.BufferGeometry());
      maxpoints = vectors.$size();
      positions = new Float32Array(maxpoints * 3);
      geometry.$addAttribute("position", new THREE.BufferAttribute(positions, 3));
      ($a = ($c = vectors.$each()).$with_index, $a.$$p = (TMP_9 = function(v, i){var self = TMP_9.$$s || this;
if (v == null) v = nil;if (i == null) i = nil;
      geometry.$attributes().$position().$array()['$[]=']($rb_plus($rb_times(i, 3), 0), v.$x());
        geometry.$attributes().$position().$array()['$[]=']($rb_plus($rb_times(i, 3), 1), v.$y());
        return geometry.$attributes().$position().$array()['$[]=']($rb_plus($rb_times(i, 3), 2), v.$z());}, TMP_9.$$s = self, TMP_9), $a).call($c);
      geometry.$setDrawRange(0, 0);
      co = $scope.get('COLOR_MAP')['$[]'](no);
      material = self.$Native(new THREE.LineBasicMaterial( { color: co, linewidth: 2 } ));
      geometry_native = geometry.$to_n();
      material_native = material.$to_n();
      line = self.$Native(new THREE.Line(geometry_native, material_native));
      (($a = [true]), $d = line, $d['$castShadow='].apply($d, $a), $a[$a.length-1]);
      (($a = [no]), $d = line, $d['$bullet_module_no='].apply($d, $a), $a[$a.length-1]);
      $gvars.bullet_lines['$[]='](no, line);
      return $gvars.scene.$add(line);}, TMP_7.$$s = self, TMP_7), $a).call($b);
    $gvars.bullet_cubes = $hash2([], {});
    ($a = ($c = $gvars.bullet_datas).$each, $a.$$p = (TMP_10 = function(no, bullet_data){var self = TMP_10.$$s || this, $a, $b, TMP_11, ret = nil;
      if ($gvars.bullet_cubes == null) $gvars.bullet_cubes = nil;
if (no == null) no = nil;if (bullet_data == null) bullet_data = nil;
    ret = [];
      ($a = ($b = bullet_data.$each()).$with_index, $a.$$p = (TMP_11 = function($c, i){var self = TMP_11.$$s || this, $a, $b, m_zrev = nil, m_yzrev = nil, matrix_r = nil, geometry = nil, co = nil, material = nil, geometry_native = nil, material_native = nil, cube = nil;
        if ($gvars.scale == null) $gvars.scale = nil;
        if ($gvars.scene == null) $gvars.scene = nil;
var matrix = $c[0];var available = $c[1];if (i == null) i = nil;
      if (available !== false && available !== nil) {
          } else {
          ret['$<<'](nil);
          return nil;;
        };
        m_zrev = self.$Native(new THREE.Matrix4()).$makeScale(1, 1, -1);
        m_yzrev = self.$Native(new THREE.Matrix4()).$makeScale(1, -1, -1);
        matrix_r = m_yzrev.$multiply(matrix).$multiply(m_zrev);
        geometry = self.$Native(new THREE.CylinderGeometry(0, 0.05, 0.1, 3, 1));
        geometry.$rotateZ($rb_divide($scope.get('PI')['$-@'](), 2));
        geometry.$translate(-0.05, 0, 0);
        geometry.$rotateY($scope.get('Math').$atan($rb_divide(1, ($rb_times(2, $scope.get('Math').$sqrt(3))))));
        geometry.$scale(1, 1, 0.5);
        geometry.$applyMatrix(matrix_r);
        geometry.$scale($gvars.scale, $gvars.scale, $gvars.scale);
        co = $scope.get('COLOR_MAP')['$[]'](no);
        material = self.$Native(new THREE.MeshLambertMaterial( {color: co} ));
        geometry_native = geometry.$to_n();
        material_native = material.$to_n();
        cube = self.$Native(new THREE.Mesh( geometry_native, material_native ));
        (($a = [true]), $b = cube, $b['$castShadow='].apply($b, $a), $a[$a.length-1]);
        (($a = [no]), $b = cube, $b['$bullet_module_no='].apply($b, $a), $a[$a.length-1]);
        (($a = [i]), $b = cube, $b['$bullet_module_frame='].apply($b, $a), $a[$a.length-1]);
        ret['$<<'](cube);
        return $gvars.scene.$add(cube.$to_n());}, TMP_11.$$s = self, TMP_11), $a).call($b);
      return $gvars.bullet_cubes['$[]='](no, ret);}, TMP_10.$$s = self, TMP_10), $a).call($c);
    $gvars.max_frame = ($a = ($d = $gvars.bullet_datas).$map, $a.$$p = (TMP_12 = function(k, fd){var self = TMP_12.$$s || this;
if (k == null) k = nil;if (fd == null) fd = nil;
    return $rb_minus(fd.$size(), 1)}, TMP_12.$$s = self, TMP_12), $a).call($d).$max();
    frame_controler = $gvars.win.$document().$getElementById("frame_controler");
    (($a = [((($f = $gvars.max_frame) !== false && $f !== nil) ? $f : 0)]), $e = frame_controler, $e['$max='].apply($e, $a), $a[$a.length-1]);
    (($a = [((($f = $gvars.max_frame) !== false && $f !== nil) ? $f : 0)]), $e = frame_controler, $e['$value='].apply($e, $a), $a[$a.length-1]);
    return self.$redraw($gvars.max_frame);
  };
  Opal.Object.$$proto.$init_tooltip = function() {
    var $a, $b, TMP_13, $c, self = this;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.tooltip == null) $gvars.tooltip = nil;

    $gvars.projector = self.$Native(new THREE.Projector());
    ($a = ($b = $gvars.win.$document()).$addEventListener, $a.$$p = (TMP_13 = function(event){var self = TMP_13.$$s || this, e = nil, rect = nil;
...
if (event == null) event = nil;
    e = self.$Native(event);
      ...
      $gvars.mouse['$[]=']("x", $rb_minus($rb_times(($rb_divide(($rb_minus(e.$clientX(), rect.$left())), $gvars.winwidth)), 2), 1));
      $gvars.mouse['$[]=']("y", $rb_plus($rb_times(($rb_divide(($rb_minus(e.$clientY(), rect.$top())), $gvars.winheight))['$-@'](), 2), 1));
      $gvars.mouse['$[]=']("left", e.$clientX());
  ...
  Opal.Object.$$proto.$tooltip_update = function() {
    ...
    if ($gvars.camera == null) $gvars.camera = nil;
    if ($gvars.bullet_cubes == null) $gvars.bullet_cubes = nil;
    if ($gvars.intersected == null) $gvars.intersected = nil;
    if ($gvars.bullet_datas == null) $gvars.bullet_datas = nil;
    if ($gvars.max_frame == null) $gvars.max_frame = nil;
    if ($gvars.tooltip == null) $gvars.tooltip = nil;

    $a = [$gvars.mouse['$[]']("x"), $gvars.mouse['$[]']("y")], mx = $a[0], my = $a[1];
    vector = self.$Native(new THREE.Vector3(mx, my, 1));
    vector.$unproject($gvars.camera);
    camera_pos_n = $gvars.camera.$position().$to_n();
    vector_n = vector.$sub($gvars.camera.$position()).$normalize().$to_n();
    ray = self.$Native(new THREE.Raycaster( camera_pos_n, vector_n ));
    intersected_obj = $gvars.bullet_cubes.$values().$flatten().$compact();
    intersects = ray.$intersectObjects(intersected_obj);
    if ($rb_gt(intersects.$length(), 0)) {
      intersects_wrapped = self.$Native(intersects[0]);
      if ((($a = intersects_wrapped.$object()['$==']($gvars.intersected)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = $gvars.intersected) !== nil && (!$a.$$is_boolean || $a == true))) {
          $gvars.intersected.$material().$color().$setHex($gvars.intersected.$currentHex())};
        $gvars.intersected = intersects_wrapped.$object();
        color = $gvars.intersected.$material().$color().$clone();
        (($a = [$gvars.intersected.$material().$color().$getHex()]), $b = $gvars.intersected, $b['$currentHex='].apply($b, $a), $a[$a.length-1]);
        $gvars.intersected.$material().$color().$setHex(4210943);
        no = $gvars.intersected.$bullet_module_no();
        frame = $gvars.intersected.$bullet_module_frame();
        flags = ($a = ($b = $gvars.bullet_datas['$[]'](no)).$map, $a.$$p = "last".$to_proc(), $a).call($b);
        $a = [flags.$index(true), flags.$rindex(true)], s = $a[0], e = $a[1];
        age = $rb_minus(frame, s);
        life = $rb_minus(e, s);
        matrix = $gvars.bullet_datas['$[]'](no)['$[]'](frame)['$[]'](0);
        translation = self.$Native(new THREE.Vector3());
        quaternion = self.$Native(new THREE.Quaternion());
        scale = self.$Native(new THREE.Vector3());
        matrix.$decompose(translation, quaternion, scale);
        euler = self.$Native(new THREE.Euler());
        euler.$setFromQuaternion(quaternion, "ZYX");
        $a = Opal.to_ary(($c = ($d = [translation.$x(), translation.$y(), translation.$z()]).$map, $c.$$p = (TMP_14 = function(v){var self = TMP_14.$$s || this;
          if ($gvars.scale == null) $gvars.scale = nil;
if (v == null) v = nil;
...
if (v == null) v = nil;
        ...
        $gvars.tooltip.$style()['$[]=']("border-left-color", color.$getStyle());
        return (($a = ["block"]), $c = $gvars.tooltip.$style(), $c['$display='].apply($c, $a), $a[$a.length-1]);
        } else {
        return nil
      };
      } else {
      if ((($a = $gvars.intersected) !== nil && (!$a.$$is_boolean || $a == true))) {
        $gvars.intersected.$material().$color().$setHex($gvars.intersected.$currentHex())};
      $gvars.intersected = nil;
      if ((($a = $gvars.tooltip) !== nil && (!$a.$$is_boolean || $a == true))) {
        return (($a = ["none"]), $c = $gvars.tooltip.$style(), $c['$display='].apply($c, $a), $a[$a.length-1])
        } else {
        return nil
      };
    };
...
/* Generated by Opal 0.8.1 */
Opal.modules["page"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  Opal.add_stubs(['$require', '$[]', '$search', '$location', '$to_i', '$getElementById', '$document', '$with_index', '$each', '$join', '$map', '$rjust', '$to_s', '$length', '$createElement', '$id=', '$add', '$classList', '$[]=', '$style', '$innerHTML=', '$appendChild', '$getElementsByTagName', '$times', '$addEventListener', '$fire', '$clear_modules', '$clear_bullet', '$get_module_list', '$hash=', '$compress', '$hash', '$==', '$sub', '$set_module_list', '$decompress', '$value', '$size', '$value=', '$split', '$selectedIndex=', '$new', '$get_gun', '$init_bullet', '$init_tooltip', '$set_query']);
  self.$require("opal");
  self.$require("native");
  self.$require("bullet");
  self.$require("anime");
  $gvars.module_max = 12;
  $gvars.module_elements = $hash2([], {});
  Opal.Object.$$proto.$page_setup = function() {
    var $a, $b, TMP_1, $d, TMP_2, $e, TMP_3, $f, TMP_4, $g, TMP_7, $h, TMP_8, self = this, m = nil, module_container = nil, module_list_html = nil, parent_html = nil, editor_container = nil, clear_module_button = nil, hsh = nil, query = nil;
    if ($gvars.win == null) $gvars.win = nil;
    if ($gvars.module_max == null) $gvars.module_max = nil;

    m = $gvars.win.$location().$search()['$[]'](/[?&^]m=(\d+)/, 1);
    $gvars.module_max = (function() {if (m !== false && m !== nil) {
      return m.$to_i()
      } else {
      return $gvars.module_max
    }; return nil; })();
    module_container = $gvars.win.$document().$getElementById("module_container");
    module_list_html = "";
    ($a = ($b = (($scope.get('BulletModule')).$$scope.get('MODULE_LIST')).$each()).$with_index, $a.$$p = (TMP_1 = function($c, index){var self = TMP_1.$$s || this;
var id = $c[0];var type = $c[1];var following = $c[2];if (index == null) index = nil;
    return module_list_html = $rb_plus(module_list_html, "<option value=" + (index) + ">" + (id) + "</option>\n")}, TMP_1.$$s = self, TMP_1), $a).call($b);
    parent_html = ($a = ($d = ($range(1, $gvars.module_max, false))).$map, $a.$$p = (TMP_2 = function(i){var self = TMP_2.$$s || this, color = nil;
      if ($gvars.module_max == null) $gvars.module_max = nil;
if (i == null) i = nil;
    color = $rb_plus("#", $scope.get('COLOR_MAP')['$[]'](i).$to_s(16).$rjust(6, "0"));
      return "<option style=\"background-color:" + (color) + "\" value=" + (i) + ">No." + (i.$to_s().$rjust($gvars.module_max.$to_s().$length(), "0")) + "</option>}";}, TMP_2.$$s = self, TMP_2), $a).call($d).$join("\n");
    ($a = ($e = ($range(1, $gvars.module_max, false))).$each, $a.$$p = (TMP_3 = function(no){var self = TMP_3.$$s || this, $a, $b, bullet_module = nil, color = nil;
      if ($gvars.win == null) $gvars.win = nil;
      if ($gvars.module_max == null) $gvars.module_max = nil;
      if ($gvars.module_elements == null) $gvars.module_elements = nil;
if (no == null) no = nil;
    bullet_module = $gvars.win.$document().$createElement("div");
      (($a = ["module:" + (no)]), $b = bullet_module, $b['$id='].apply($b, $a), $a[$a.length-1]);
    ...
    ($a = ($f = ["select", "input"]).$each, $a.$$p = (TMP_4 = function(tagname){var self = TMP_4.$$s || this, $a, $b, TMP_5, elems = nil;
if (tagname == null) tagname = nil;
    elems = editor_container.$getElementsByTagName(tagname);
      return ($a = ($b = elems.$length()).$times, $a.$$p = (TMP_5 = function(i){var self = TMP_5.$$s || this, $a, $b, TMP_6, elem = nil;
if (i == null) i = nil;
      elem = elems['$[]'](i);
        return ($a = ($b = elem).$addEventListener, $a.$$p = (TMP_6 = function(event){var self = TMP_6.$$s || this;
if (event == null) event = nil;
        return self.$fire()}, TMP_6.$$s = self, TMP_6), $a).call($b, "input");}, TMP_5.$$s = self, TMP_5), $a).call($b);}, TMP_4.$$s = self, TMP_4), $a).call($f);
    clear_module_button = $gvars.win.$document().$getElementById("clear_module_button");
    ($a = ($g = clear_module_button).$addEventListener, $a.$$p = (TMP_7 = function(event){var self = TMP_7.$$s || this;
if (event == null) event = nil;
    self.$clear_modules();
      return self.$clear_bullet();}, TMP_7.$$s = self, TMP_7), $a).call($g, "click");
    editor_container = $gvars.win.$document().$getElementById("editor_container");
    ($a = ($h = editor_container).$addEventListener, $a.$$p = (TMP_8 = function(event){var self = TMP_8.$$s || this, $a, $b, module_list = nil;
      if ($gvars.win == null) $gvars.win = nil;
if (event == null) event = nil;
    module_list = self.$get_module_list();
      return (($a = [self.$compress(module_list)]), $b = $gvars.win.$location(), $b['$hash='].apply($b, $a), $a[$a.length-1]);}, TMP_8.$$s = self, TMP_8), $a).call($h, "focusout");
    hsh = $gvars.win.$location().$hash();
    if (hsh['$==']("")) {
      return nil
      } else {
      query = hsh.$sub(/^#/, "");
      return self.$set_module_list(self.$decompress(query));
    };
  };
  Opal.Object.$$proto.$get_module_list = function() {
    var $a, $b, TMP_9, self = this, module_list = nil;
    if ($gvars.module_elements == null) $gvars.module_elements = nil;

    module_list = $hash2([], {});
    ($a = ($b = $gvars.module_elements).$each, $a.$$p = (TMP_9 = function(no, elem){var self = TMP_9.$$s || this, index = nil, rotz = nil, roty = nil, rotx = nil, parent = nil, timing = nil, data = nil;
      if ($gvars.win == null) $gvars.win = nil;
if (no == null) no = nil;if (elem == null) elem = nil;
    index = $gvars.win.$document().$getElementById("index:" + (no)).$value();
      rotz = $gvars.win.$document().$getElementById("rotz:" + (no)).$value();
      roty = $gvars.win.$document().$getElementById("roty:" + (no)).$value();
      rotx = $gvars.win.$document().$getElementById("rotx:" + (no)).$value();
      parent = $gvars.win.$document().$getElementById("parent:" + (no)).$value();
      timing = $gvars.win.$document().$getElementById("timing:" + (no)).$value();
      if (index['$==']("null")) {
        return nil
        } else {
        data = $hash2([], {});
        ...
        return module_list['$[]='](no, data);
      };}, TMP_9.$$s = self, TMP_9), $a).call($b);
    return module_list;
  };
  Opal.Object.$$proto.$set_module_list = function(module_list) {
    var $a, $b, TMP_10, $c, self = this;
    if ($gvars.win == null) $gvars.win = nil;

    ($a = ($b = module_list).$each, $a.$$p = (TMP_10 = function(no, data){var self = TMP_10.$$s || this, $a, $b, index = nil, rotz = nil, roty = nil, rotx = nil, parent = nil, timing = nil;
      if ($gvars.module_elements == null) $gvars.module_elements = nil;
      if ($gvars.win == null) $gvars.win = nil;
if (no == null) no = nil;if (data == null) data = nil;
    if ($rb_gt(no.$to_i(), $gvars.module_elements.$size())) {
        return nil;};
      if (no.$to_s().$to_i()['$=='](no)) {
        index = data['$[]']("index");
        rotz = data['$[]']("rot")['$[]'](0);
        ...
        parent = data['$[]']("parent");
        timing = data['$[]']("timing");
        (($a = [index]), $b = $gvars.win.$document().$getElementById("index:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
        (($a = [rotz]), $b = $gvars.win.$document().$getElementById("rotz:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
        (($a = [roty]), $b = $gvars.win.$document().$getElementById("roty:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
        (($a = [rotx]), $b = $gvars.win.$document().$getElementById("rotx:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
        if (parent !== false && parent !== nil) {
          (($a = [parent]), $b = $gvars.win.$document().$getElementById("parent:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
          return (($a = [timing]), $b = $gvars.win.$document().$getElementById("timing:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
          } else {
          return nil
        };
      } else if (no['$==']("g")) {
        (($a = [data['$[]'](0)]), $b = $gvars.win.$document().$getElementById("rotz:g"), $b['$value='].apply($b, $a), $a[$a.length-1]);
        (($a = [data['$[]'](1)]), $b = $gvars.win.$document().$getElementById("roty:g"), $b['$value='].apply($b, $a), $a[$a.length-1]);
        return (($a = [data['$[]'](2)]), $b = $gvars.win.$document().$getElementById("rotx:g"), $b['$value='].apply($b, $a), $a[$a.length-1]);
        } else {
        return nil
      };}, TMP_10.$$s = self, TMP_10), $a).call($b);
    return (($a = [self.$compress(module_list)]), $c = $gvars.win.$location(), $c['$hash='].apply($c, $a), $a[$a.length-1]);
  };
  Opal.Object.$$proto.$get_gun = function() {
    var self = this, rotz = nil, roty = nil, rotx = nil;
    if ($gvars.win == null) $gvars.win = nil;

    rotz = $gvars.win.$document().$getElementById("rotz:g").$value();
    roty = $gvars.win.$document().$getElementById("roty:g").$value();
    rotx = $gvars.win.$document().$getElementById("rotx:g").$value();
    return [rotz, roty, rotx];
  };
  Opal.Object.$$proto.$compress = function(module_list) {
    var $a, $b, TMP_11, self = this;

    return ($a = ($b = module_list).$map, $a.$$p = (TMP_11 = function(no, data){var self = TMP_11.$$s || this, index = nil, rot = nil, parent = nil, timing = nil;
if (no == null) no = nil;if (data == null) data = nil;
    index = data['$[]']("index");
      rot = data['$[]']("rot").$join(".");
      parent = data['$[]']("parent");
      timing = data['$[]']("timing");
      return $rb_plus("" + (no) + "=" + (index) + ":" + (rot), ((function() {if (parent !== false && parent !== nil) {
        return ":" + (parent) + ":" + (timing)
        } else {
        return ""
      }; return nil; })()));}, TMP_11.$$s = self, TMP_11), $a).call($b).$join(";");
  };
  Opal.Object.$$proto.$decompress = function(query) {
    var $a, $b, TMP_12, self = this, module_list = nil;

    module_list = $hash2([], {});
    ($a = ($b = query.$split(";")).$each, $a.$$p = (TMP_12 = function(text){var self = TMP_12.$$s || this, $a, no = nil, data = nil, index = nil, rot = nil, parent = nil, timing = nil, d = nil;
if (text == null) text = nil;
    $a = Opal.to_ary(text.$split("=")), no = ($a[0] == null ? nil : $a[0]), data = ($a[1] == null ? nil : $a[1]);
      if (no.$to_i().$to_s()['$=='](no)) {
        $a = Opal.to_ary(data.$split(":")), index = ($a[0] == null ? nil : $a[0]), rot = ($a[1] == null ? nil : $a[1]), parent = ($a[2] == null ? nil : $a[2]), timing = ($a[3] == null ? nil : $a[3]);
        rot = rot.$split(".");
        d = $hash2([], {});
        d['$[]=']("index", index.$to_i());
        d['$[]=']("rot", rot);
        if (parent !== false && parent !== nil) {
          ...
          d['$[]=']("timing", timing);};
        return module_list['$[]='](no.$to_i(), d);
      } else if (no['$==']("g")) {
        rot = data.$split(".");
        return module_list['$[]=']("g", rot);
        } else {
        return nil
      };}, TMP_12.$$s = self, TMP_12), $a).call($b);
    return module_list;
  };
  Opal.Object.$$proto.$clear_modules = function() {
    var $a, $b, TMP_13, $c, self = this;
    if ($gvars.module_max == null) $gvars.module_max = nil;
    if ($gvars.win == null) $gvars.win = nil;

    ($a = ($b = ($range(1, $gvars.module_max, false))).$each, $a.$$p = (TMP_13 = function(no){var self = TMP_13.$$s || this, $a, $b;
      if ($gvars.win == null) $gvars.win = nil;
if (no == null) no = nil;
    (($a = [0]), $b = $gvars.win.$document().$getElementById("index:" + (no)), $b['$selectedIndex='].apply($b, $a), $a[$a.length-1]);
      (($a = [0]), $b = $gvars.win.$document().$getElementById("rotz:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
      (($a = [0]), $b = $gvars.win.$document().$getElementById("roty:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
      (($a = [0]), $b = $gvars.win.$document().$getElementById("rotx:" + (no)), $b['$value='].apply($b, $a), $a[$a.length-1]);
      (($a = [0]), $b = $gvars.win.$document().$getElementById("parent:" + (no)), $b['$selectedIndex='].apply($b, $a), $a[$a.length-1]);
      return (($a = [0]), $b = $gvars.win.$document().$getElementById("timing:" + (no)), $b['$selectedIndex='].apply($b, $a), $a[$a.length-1]);}, TMP_13.$$s = self, TMP_13), $a).call($b);
    (($a = [0]), $c = $gvars.win.$document().$getElementById("rotz:g"), $c['$value='].apply($c, $a), $a[$a.length-1]);
    (($a = [0]), $c = $gvars.win.$document().$getElementById("roty:g"), $c['$value='].apply($c, $a), $a[$a.length-1]);
    (($a = [0]), $c = $gvars.win.$document().$getElementById("rotx:g"), $c['$value='].apply($c, $a), $a[$a.length-1]);
    return (($a = [""]), $c = $gvars.win.$location(), $c['$hash='].apply($c, $a), $a[$a.length-1]);
  };
  Opal.Object.$$proto.$fire = function() {
    var self = this, module_list = nil, b = nil;

    self.$clear_bullet();
    module_list = self.$get_module_list();
    b = $scope.get('Bullet').$new(module_list);
    $gvars.bullet_datas = b.$fire(self.$get_gun());
    self.$init_bullet();
    return self.$init_tooltip();
  };
  Opal.Object.$$proto.$set_query = function(query) {
    var self = this;

    self.$clear_modules();
    self.$set_module_list(self.$decompress(query));
    return self.$fire();
  };
  return (Opal.Object.$$proto.$set_sample = function() {
    var self = this;

    return self.$set_query("1=1:45.45.0;2=0:0.0.0;3=5:0.0.0:2:same;4=1:0.-90.0:3:same;5=5:0.0.90:2:d02;6=1:0.0.0:5:d02;7=4:0.0.0");
  }, nil) && 'set_sample';
};
...
(function(Opal) {
  ...
  var $a, $b, $c, $d, TMP_1, TMP_2, TMP_3, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $hash = Opal.hash;

  Opal.add_stubs(['$require', '$Native', '$default_proc=', '$lambda', '$[]=', '$rand', '$[]', '$onload', '$page_setup', '$init_anime', '$animate', '$==', '$hash', '$location', '$fire']);
  self.$require("opal");
  self.$require("native");
  self.$require("math");
  self.$require("bullet");
  self.$require("anime");
  self.$require("page");
  $gvars.win = self.$Native(window);
  Opal.cdecl($scope, 'COLOR_MAP', $hash(1, 16711680, 2, 16776960, 3, 65280, 4, 65535, 5, 255, 6, 16711935, 7, 8388608, 8, 8421376, 9, 32768, 10, 32896, 11, 128, 12, 8388736, 13, 0, 14, 8421504, 15, 12632256, 16, 16777215));
  (($a = [($c = ($d = self).$lambda, $c.$$p = (TMP_1 = function(h, k){var self = TMP_1.$$s || this;
if (h == null) h = nil;if (k == null) k = nil;
  return h['$[]='](k, $rb_plus($rb_plus($rb_times($rb_times(self.$rand(6), 51), 65536), $rb_times($rb_times(self.$rand(6), 51), 256)), $rb_times(self.$rand(6), 51)))}, TMP_1.$$s = self, TMP_1), $c).call($d)]), $b = $scope.get('COLOR_MAP'), $b['$default_proc='].apply($b, $a), $a[$a.length-1]);
  Opal.Object.$$proto.$debug = function(i) {
    var self = this;

    return $scope.get('COLOR_MAP')['$[]'](i);
  };
  Opal.Object.$$proto.$onload = TMP_2 = function() {
    var self = this, $iter = TMP_2.$$p, block = $iter || nil;

    TMP_2.$$p = null;
    window.onload = block;
  };
  return ($a = ($b = self).$onload, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;
    if ($gvars.win == null) $gvars.win = nil;

  self.$page_setup();
    self.$init_anime();
    self.$animate();
    if ($gvars.win.$location().$hash()['$==']("")) {
      return nil
      } else {
      return self.$fire()
