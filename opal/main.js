...
Opal.modules["anime"] = function(Opal) {
  ...
  Opal.Object.$$proto.$init_anime = function() {
    var $a, $b, TMP_1, $c, TMP_2, self = this, el_mc = nil, light = nil, plane_geometry = nil, plane_material = nil, plane_geometry_n = nil, plane_material_n = nil, plane = nil, grid_xz = nil, grid_xy = nil, lgeo = nil, verts = nil, lmat = nil, lgeo_n = nil, lmat_n = nil, centerline = nil, camera_native = nil, domelement_native = nil, frame_controler = nil;
    ...
    if ($rb_gt($rb_divide($gvars.win.$innerWidth(), $gvars.win.$innerHeight()), 1.2)) {
      $gvars.winwidth = [$rb_minus($rb_minus($gvars.win.$innerWidth(), el_mc.$clientWidth()), 70), 320].$max();
      $gvars.winheight = [$rb_minus($gvars.win.$innerHeight(), 60), 240].$max();
      } else {
      $gvars.winwidth = [$rb_minus($gvars.win.$innerWidth(), 20), 320].$max();
      $gvars.winheight = [$rb_minus($gvars.win.$innerHeight(), 60), 240].$max();
    };
